...
public class AssetReportTest {
	...
	@Before
	public void setUp() {
		records = new RecordSet(new String[] { "ISSUE_GROUP", "ISSUE_FAMILY",
				"ISSUE_NAME", "QUANTITY", "MARKET_PRICE", "TERM_ONE",
				"TERM_TWO" });
	...
	public void mixed() throws Exception {
		records.addRow(new String[] { "Assets", "family", "Equity",
				QUANTITY_10, MARKET_PRICE_2, TOTAL_COST_4, RISK_75 });
	...
	public void multiGroup() throws Exception {
		records.addRow(new String[] { "Alpha", "family", "Alpha Equity",
				QUANTITY_10, MARKET_PRICE_2, TOTAL_COST_4, RISK_75 });
		records.addRow(new String[] { "Beta", "family", "Beta Equity",
				QUANTITY_10, MARKET_PRICE_2, TOTAL_COST_4, RISK_75 });
